...
const DraftEditorCompositionHandler = {
  ...
  resolveComposition(editor: DraftEditor): void {
    ...
    mutations.forEach((composedChars, offsetKey) => {
      ...
      // fix selectionBefore and selectionAfter
      // keep in mind: editorState HAS NOT been reassigned until now
      contentState = contentState.merge({
        selectionAfter: editorState.getSelection(),
        selectionBefore: editorState.getCurrentContent().getSelectionBefore(),
      });
